...
class Settings(BaseSettings):
    ...
    # P0-1 (2026-07-19): marks THIS process as the live real-money deployment. When
    # true AND WEATHER_LIVE_TRADING is false, weather entries HALT (paused) instead
    # of writing paper-sim rows into the live DB. Set true ONLY on the MX live box;
    # the NYC paper box leaves it false so its normal paper-simulate behavior stands.
    WEATHER_LIVE_DEPLOYMENT: bool = False
