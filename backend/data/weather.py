...
CITY_CONFIG: Dict[str, dict] = {
    ...
    # ── 37 cities added 2026-07-20 (full Polymarket daily-temp universe). Stations
    # + coords verified against each market's gamma resolution text / wunderground
    # URL (airport ICAO -> OpenFlights coords). Intl markets quote °C (parser ->°F).
    "amsterdam": {"name": "Amsterdam", "lat": 52.309, "lon": 4.764, "nws_station": "EHAM"},
    "ankara": {"name": "Ankara", "lat": 40.1281, "lon": 32.9951, "nws_station": "LTAC"},
    "atlanta": {"name": "Atlanta", "lat": 33.6367, "lon": -84.4281, "nws_station": "KATL"},
    "austin": {"name": "Austin", "lat": 30.1945, "lon": -97.6699, "nws_station": "KAUS"},
    "beijing": {"name": "Beijing", "lat": 40.0801, "lon": 116.5846, "nws_station": "ZBAA"},
    "buenos_aires": {"name": "Buenos Aires", "lat": -34.8222, "lon": -58.5358, "nws_station": "SAEZ"},
    "busan": {"name": "Busan", "lat": 35.1795, "lon": 128.9382, "nws_station": "RKPK"},
    "cape_town": {"name": "Cape Town", "lat": -33.9648, "lon": 18.6017, "nws_station": "FACT"},
    "chengdu": {"name": "Chengdu", "lat": 30.5785, "lon": 103.9471, "nws_station": "ZUUU"},
    "chongqing": {"name": "Chongqing", "lat": 29.7192, "lon": 106.6417, "nws_station": "ZUCK"},
    "dallas": {"name": "Dallas", "lat": 32.8471, "lon": -96.8518, "nws_station": "KDAL"},
    "guangzhou": {"name": "Guangzhou", "lat": 23.3924, "lon": 113.2988, "nws_station": "ZGGG"},
    "helsinki": {"name": "Helsinki", "lat": 60.3172, "lon": 24.9633, "nws_station": "EFHK"},
    "hong_kong": {"name": "Hong Kong", "lat": 22.3021, "lon": 114.1747, "nws_station": "HKO"},
    "houston": {"name": "Houston", "lat": 29.6454, "lon": -95.2789, "nws_station": "KHOU"},
    "istanbul": {"name": "Istanbul", "lat": 41.2753, "lon": 28.7519, "nws_station": "LTFM"},
    "karachi": {"name": "Karachi", "lat": 24.9065, "lon": 67.1608, "nws_station": "OPKC"},
    "kuala_lumpur": {"name": "Kuala Lumpur", "lat": 2.7456, "lon": 101.7099, "nws_station": "WMKK"},
    "lucknow": {"name": "Lucknow", "lat": 26.7606, "lon": 80.8893, "nws_station": "VILK"},
    "madrid": {"name": "Madrid", "lat": 40.4722, "lon": -3.5608, "nws_station": "LEMD"},
    "manila": {"name": "Manila", "lat": 14.5086, "lon": 121.0195, "nws_station": "RPLL"},
    "mexico_city": {"name": "Mexico City", "lat": 19.4363, "lon": -99.0721, "nws_station": "MMMX"},
    "moscow": {"name": "Moscow", "lat": 55.5915, "lon": 37.2615, "nws_station": "UUWW"},
    "munich": {"name": "Munich", "lat": 48.3538, "lon": 11.7861, "nws_station": "EDDM"},
    "paris": {"name": "Paris", "lat": 48.9694, "lon": 2.4414, "nws_station": "LFPB"},
    "qingdao": {"name": "Qingdao", "lat": 36.2661, "lon": 120.3744, "nws_station": "ZSQD"},
    "sao_paulo": {"name": "Sao Paulo", "lat": -23.4356, "lon": -46.4731, "nws_station": "SBGR"},
    "seattle": {"name": "Seattle", "lat": 47.4489, "lon": -122.3094, "nws_station": "KSEA"},
    "seoul": {"name": "Seoul", "lat": 37.4691, "lon": 126.4505, "nws_station": "RKSI"},
    "shanghai": {"name": "Shanghai", "lat": 31.1434, "lon": 121.8052, "nws_station": "ZSPD"},
    "shenzhen": {"name": "Shenzhen", "lat": 22.6393, "lon": 113.8107, "nws_station": "ZGSZ"},
    "singapore": {"name": "Singapore", "lat": 1.3502, "lon": 103.9944, "nws_station": "WSSS"},
    "taipei": {"name": "Taipei", "lat": 25.0694, "lon": 121.5525, "nws_station": "RCSS"},
    "tel_aviv": {"name": "Tel Aviv", "lat": 32.0114, "lon": 34.8867, "nws_station": "LLBG"},
    "tokyo": {"name": "Tokyo", "lat": 35.5523, "lon": 139.7798, "nws_station": "RJTT"},
    "warsaw": {"name": "Warsaw", "lat": 52.1657, "lon": 20.9671, "nws_station": "EPWA"},
    "wellington": {"name": "Wellington", "lat": -41.3272, "lon": 174.8053, "nws_station": "NZWN"},
}
