...
async def startup():
    ...
    # CRYPTO5050 moved to its own project 2026-07-22 PM (~/Projects/
    # trooth-crypto5050, service trooth-crypto5050, crypto.troothquant.com).
    # Crypto deploys must NEVER restart this bot (zero coupling).
